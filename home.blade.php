  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="index.html"><span class="img" style="background-image: url(images/author.jpg);"></span>nbhnrzk</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="index.html">Home</a></li>
					<li><a href="collection.html">Album</a></li>
		...
		<div id="colorlib-main">
				...
				<div class="hero-wrap">
					...
					<div class="d-flex align-items-center js-fullheight">
						<div class="author-image text img d-flex">
					      ...
					      <div class="slider-item js-fullheight" style="background-image: url(images/image_4.jpg);">
					      </div>

					      <div class="slider-item js-fullheight" style="background-image: url(images/image_6.jpg);">
					      </div>

					      <div class="slider-item js-fullheight" style="background-image: url(images/image_2.jpg);">
					      </div>
					    </section>
						</div>
						<div class="author-info text p-3 p-md-5">
							<div class="desc">
								...
								<span class="subheading">Hello! Saya</span>
								<h1 class="big-letter">nbhnrzk.ml</h1>
								<h1 class="mb-4">Nabhan Rizqullah <span>Mahasiswa Teknik Informatika </span></h1>
								<p class="mb-4">Seorang Mahasiswa yang saat ini sedang menempuh Kuliah Jurusan Teknik Informatika Universitas Islam Negeri Sunan Gunung Djati Bandung</p>
								<h3 class="signature h1">nbhnrzk</h3>
			...
			<section class="ftco-section instagram">
	          ...
	          <div class="col-md-7 heading-section heading-section-2 text-center ftco-animate">
	            <h2 class="mb-4">Ikuti saya di Instagram</h2>
	          </div>
	        </div>  
	        ...
	        <div class="row mb-5">
	          ...
	          <div class="col-md">
	             <div class="ftco-footer-widget mb-4">
	              <h2 class="ftco-heading-2">Agenda</h2>
	          ...
	          <div class="col-md">
	            <div class="ftco-footer-widget mb-4">
	            	...
	            	<div class="block-23 mb-3">
		              <ul>
		                <li><span class="icon icon-map-marker"></span><span class="text">Jl.Citra Indah Blok E37 RT06 RW20 Jayamekar, Padalarang, Bandung Barat </span></li>
		                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+62 8969 6833 912</span></a></li>
		                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">nbhnrizqu@gmail.com</span></a></li>
		              </ul>
		            </div>
	            </div>
	          </div>
	  ...
	  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Nabhan Rizqullah | This Web unfinished <i class="icon-heart" aria-hidden="true"></i> by <a href="https://www.instagram.com/nbhnrzk" target="_blank">@nbhnrzk</a>
